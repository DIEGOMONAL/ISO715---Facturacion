    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <%
                    String rolNav = (String) session.getAttribute("rol");
                    boolean esAdminNav = "ADMIN".equalsIgnoreCase(rolNav);
                    boolean esAuditorNav = "AUDITOR".equalsIgnoreCase(rolNav);
                    boolean esSupervisorNav = "SUPERVISOR".equalsIgnoreCase(rolNav);
                %>
                <% if (esAdminNav) { %>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle ${param.page eq 'articulos' || param.page eq 'clientes' || param.page eq 'condiciones' || param.page eq 'vendedores' || param.page eq 'usuarios' ? 'active' : ''}" href="#" id="catDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Catálogos</a>
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="catDropdown">
                        ...
                        <li><a class="dropdown-item ${param.page eq 'usuarios' ? 'active' : ''}" href="${pageContext.request.contextPath}/usuarios">Usuarios</a></li>
                    </ul>
                </li>
                <% } %>
                <li class="nav-item dropdown">
