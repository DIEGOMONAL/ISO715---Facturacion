            ...
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/facturas" method="post" id="formFactura">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="date"
                                   ...
                                   id="fecha"
                                   name="fecha"
                                   value="<%= esEdicion && factura.getFecha() != null ? factura.getFecha().toString() : "" %>"
                                   required>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-custom" id="tablaDetalles">
                            ...
                            <tr>
                                ...
                                <td><input type="number" min="1" step="1" class="form-control cantidad-input" name="cantidad" value="<%= d.getCantidad() %>" required></td>
                                <td><input type="text" inputmode="decimal" class="form-control precio-input" name="precioUnitario" value="<%= new java.text.DecimalFormat("0.00").format(d.getPrecioUnitario()) %>" required placeholder="0.00"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="number" min="1" step="1" class="form-control cantidad-input" name="cantidad" value="1" required></td>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-end">
                            <div><strong>Subtotal: RD$ </strong><span id="subtotalFactura">0.00</span></div>
                            <div><strong>ITBIS (18%): RD$ </strong><span id="itbisFactura">0.00</span></div>
...
(function() {
    ...
    const subtotalSpan = document.getElementById('subtotalFactura');
    const itbisSpan = document.getElementById('itbisFactura');
    ...
    function actualizarTotal() {
        ...
        tbody.querySelectorAll('tr').forEach(function(r) {
            subtotal += calcularSubtotal(r);
        });
        const itbis = subtotal * 0.18;
        const total = subtotal + itbis;
        subtotalSpan.textContent = formatoMoneda(subtotal);
        itbisSpan.textContent = formatoMoneda(itbis);
