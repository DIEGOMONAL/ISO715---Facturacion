        ...
        <form method="get" class="filtros-bar d-flex flex-wrap gap-2 align-items-end">
            ...
            <div class="d-flex gap-2 align-items-center flex-wrap">
                ...
                <select name="ordenar" class="form-select form-select-sm" style="width: auto; min-width: 220px;">
                    ...
                    <option value="dias_asc" <%= "dias_asc".equals(ordenar) ? "selected" : "" %>>Cant. Días (Ascendente)</option>
                    <option value="dias_desc" <%= "dias_desc".equals(ordenar) ? "selected" : "" %>>Cant. Días (Descendente)</option>
                </select>
